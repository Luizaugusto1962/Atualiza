...
DEFAULT_PRESS_TIMEOUT="${DEFAULT_PRESS_TIMEOUT:-12}"
...
DEFAULT_PROGS_ATUAL_DIR="${DEFAULT_PROGS_ATUAL_DIR:-${SCRIPT_DIR}/programas/atual}"
DEFAULT_PROGS_DIR="${DEFAULT_PROGS_DIR:-${SCRIPT_DIR}/programas/anterior}"
...
export DEFAULT_PROGS_DIR DEFAULT_PROGS_ATUAL_DIR DEFAULT_ENVIA_DIR
